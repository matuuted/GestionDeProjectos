...
En la Figura \ref{fig:AoN} se puede ver el diagrama Activity on Node del presente proyecto. El camino crítico en el
diagrama está representado por los bloques que tienen un recuadro rojo.

\begin{figure}[htpb]
\centering 
\includegraphics[width=.86\textwidth]{./Figuras/OnNode.pdf}
