...
\item Planificación y gestión del proyecto (80 h)
	...
	\end{enumerate}
\item Investigación y análisis técnico (120 h)
	\begin{enumerate}
	...
	\item Investigación de protocolos Wi-Fi y BLE para comunicación del sistema (10 h)
	\end{enumerate}
\item Desarrollo de hardware (150 h)
	\begin{enumerate}
	...
	\item Pruebas eléctricas y de funcionamiento inicial (20 h)
	\end{enumerate}
\item Desarrollo de Software (170 h)	
	\begin{enumerate}
	...
	\item Optimización del código y pruebas de funcionamiento (15 h)	
	\end{enumerate}	
